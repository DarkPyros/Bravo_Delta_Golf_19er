/*------------------------------------------------------------------*-
  ...
  *** THESE ARE THE CORE SCHEDULER FUNCTIONS ***
  --- These functions may be used with all CC430 devices ---
...
-*------------------------------------------------------------------*/
tByte hSCH_Delete_Task(tByte Task_index)
{
	tByte Return_code;
